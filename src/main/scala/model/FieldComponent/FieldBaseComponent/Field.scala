...
case class Field(groeße: Int, array: Array[Array[Char]] /*, pos1: Char, pos2: Char, pos3: Char, pos4: Char, pos5: Char, pos6: Char, pos7: Char, pos8: Char, circle*/) extends FieldInterface {
    ...
    def line(cellWidth: Int = 6/* number: Int = 2*/): String = ("|" + " " * cellWidth) * 2 + "|" + eol 
    ...
    def line2(cellWidth: Int = 4 /* cellWidth2: Int = 6, number: Int = 2*/): String = "| " + ("|" + " " * cellWidth)/* + ("|" + " " * cellWidth2)* (number - 2)*/ + ("|" + " " * cellWidth) + "| |" + eol
