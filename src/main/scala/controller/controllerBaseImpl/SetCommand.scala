...
class SetCommand(ind1:Int, ind2: Int, player1: Char, controller: Controller, millList: MillListInterface) extends Command{

  override def doStep: Unit = {
    controller.controllerPlaceStones(ind1, ind2, player1)}
