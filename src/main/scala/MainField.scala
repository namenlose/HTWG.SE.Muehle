...
val mesh = (bar(groeße) + line(groeße) + cells(groeße - 2) + line2(groeße - 2) + cells3(groeße - 4) + cells4(2, 2 *(groeße - 4) + 1)) + (cells3(groeße -4) + line2(groeße - 2) + cells(groeße - 2) + line(groeße) + bar(groeße))
